  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 backdrop-blur-xl bg-vault-950/70 border-b border-vault-800/30">
      ...
      <a
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-vault-200 border border-vault-700/60 hover:border-vault-500 hover:text-vault-50 hover:bg-vault-800/40 transition-all duration-200"
      >
